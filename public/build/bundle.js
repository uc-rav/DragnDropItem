...
var app = (function () {
    ...
    /* clsSMFill\DragnDrop.svelte generated by Svelte v3.38.2 */

    const { console: console_1$2 } = globals;
    const file$2 = "clsSMFill\\DragnDrop.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div4, file$2, 170, 4, 5455);
    			attr_dev(div5, "id", "FillnTheBlanks");
    			attr_dev(div5, "class", "svelte-1j3azsf");
    			add_location(div5, file$2, 167, 0, 5373);
    		},
    ...
    background-color: #f1f1f1; width: 100px;">Textbox</span>`);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<DragnDrop> was created with unknown prop '${key}'`);
    	});
    ...
    /* clsSMFill\DragnDropPreview.svelte generated by Svelte v3.38.2 */

    const { console: console_1$1 } = globals;
    const file$1 = "clsSMFill\\DragnDropPreview.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "svelte-75npp3");
    			add_location(button0, file$1, 129, 8, 4706);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "id", "checkButton");
    			attr_dev(button1, "class", "svelte-75npp3");
    			add_location(button1, file$1, 130, 8, 4786);
    			attr_dev(div0, "id", "DragnDrop_Header");
    			attr_dev(div0, "class", "svelte-75npp3");
    			add_location(div0, file$1, 128, 4, 4669);
    			attr_dev(p, "class", "svelte-75npp3");
    			add_location(p, file$1, 133, 8, 4923);
    			attr_dev(div1, "id", "DragnDrop_Body");
    			attr_dev(div1, "class", "svelte-75npp3");
    			add_location(div1, file$1, 132, 4, 4888);
    			attr_dev(div2, "id", "DragnDrop_Footer");
    			attr_dev(div2, "class", "svelte-75npp3");
    			add_location(div2, file$1, 135, 4, 4965);
    			attr_dev(div3, "id", "DragnDrop");
    			attr_dev(div3, "class", "svelte-75npp3");
    			add_location(div3, file$1, 127, 0, 4643);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    padding: 5px 20px;"></span>`);
    	...
    	onMount(() => {
    		...
    		DragnDrop_Footer.addEventListener("drop", () => {
    			drop(event);
    		});

    		DragnDrop_Footer.addEventListener("dragover", () => {
    			allowDrop(event);
    		});
    		...
    		for (let i = 0; i < listItem.length; i++) {
    			...
    			document.getElementById(`input${i}`).addEventListener("drop", () => {
    				drop(event);
    			});

    			document.getElementById(`input${i}`).addEventListener("dragover", () => {
    				allowDrop(event);
    			});
    		...
    		for (let i = 0; i < array.length; i++) {
    			...
    			document.getElementById(`span${i}`).addEventListener("dragstart", () => {
    				drag(event);
    			});
    		}
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<DragnDropPreview> was created with unknown prop '${key}'`);
    	});
    ...
    function create_else_block(ctx) {
    	let dragndroppreview;
    	let current;
    	dragndroppreview = new DragnDropPreview({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(dragndroppreview.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(dragndroppreview, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(dragndroppreview.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(dragndroppreview.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(dragndroppreview, detaching);
    		}
    	};
    ...
    function create_if_block(ctx) {
    	let dragndrop;
    	let current;
    	dragndrop = new DragnDrop({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(dragndrop.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(dragndrop, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(dragndrop.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(dragndrop.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(dragndrop, detaching);
    		}
    	};
